...
from irrm_codec.datasets import ForwardDataset, collate_forward
...
def main():
    ...
    try:
        ...
        model = ForwardModel(output_dim=prepared["embedding_dim"], max_len=args.max_len).to(device)
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            save_checkpoint(
                ...
                epoch,
                val_metrics,
                extra={"task": "forward", "max_len": args.max_len, "embedding_dim": prepared["embedding_dim"]},
            )
